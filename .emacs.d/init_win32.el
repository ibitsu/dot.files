...
(setq exec-path
      (append
       (list "/usr/local/bin" "/usr/bin") exec-path)
      )
...
(autoload 'wl-other-frame "Wanderlust on new frame." t)
(autoload 'wl-draft "wl-draft" "Write draft with Wanderlust." t)
;(setq ssl-certificate-directory "/Users/okada/.w3/certs")
(setq ssl-certificate-directory "/cygdrive/c/Users/okada/.w3/certs")

(setq starttls-negotiation-by-kill-program t)
(setq starttls-kill-program "c:/Users/okada/cygwin/bin/kill")
...
;; this workaround went into $HOME/.emacs-w3m
