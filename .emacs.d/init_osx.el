...
;        "/Users/shun/bin" "/usr/local/sbin" "/usr/X11R6/bin" $PATH))
...
(setq backup-directory-alist
      '(
        ("^/etc/" . "/Users/shun/tmp/etc")
        ("." . "/Users/shun/tmp/emacs")
        ))
...
;(setq w3m-home-page "/Users/shun/.w3m/bookmark.html")
...
;; emacs-nav
(add-to-list 'load-path "/Users/shun/repos/emacs-nav/")
(require 'nav)
...
;;; twittering-mode
;(load "/Users/shun/repos/git/twittering-mode/twittering-mode.el")
...
;(setq twittering-tmp-dir "/Users/shun/tmp/twittering-mode/cache/") ; Directory to store buddy icons
